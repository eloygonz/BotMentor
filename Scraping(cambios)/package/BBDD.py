            ...
            for f in t:
                for c in f:
                    ...
                    if(len(c) == 6):
                        ...
                        aux = c[0].split(",")
                        apellidos = aux[0].replace("  ", " ");

                        reg = (cont, aux[1].strip(), apellidos.strip(), c[1].strip(), c[2].strip(), c[3].strip())
                        ...
                        reg = (cont, aux[1].strip(), apellidos.strip(), c[1].strip(), c[2].strip(), " ")
    ...
    def insertarTutoriasBBDD(self, t, id_profesor, cursor):
        ...
        for k, v in t.items():
            ...
            if(len(v) == 3):
                ...
                hora = "no tiene tutorias en este cuatrimestre"
